...
public class Game {
	Hero hero;
	Guard guard;package dkeep.logic;
...
public class Game {
	...
	public char[][] updateGame(char herocommand) {
		...
		try {
			...
			System.out.println("Exce̤̣o mov hero");
		}
	...
	public boolean checkHeroGetsCaught(Character c) {
		if (c.id == 'G' && (map.getmap()[c.coordY - 1][c.coordX] == 'H'
				|| map.getmap()[c.coordY + 1][c.coordX] == 'H'
				|| map.getmap()[c.coordY][c.coordX - 1] == 'H'
				|| map.getmap()[c.coordY][c.coordX + 1] == 'H'))
			return true;
